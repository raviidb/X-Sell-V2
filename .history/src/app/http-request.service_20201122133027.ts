...
export class HttpRequestService {
  ...
  initiateKYC(Request_Key,RequestId,GoogleApplicationId,CallbackUrl):Observable<any>{
    return this.http.post<any>(this.baseurl + 'LOS-V2-Initiate_KYC', {Request_Key,RequestId,GoogleApplicationId,CallbackUrl});
  }
  ...
  initiateEMandate(Request_Key,GoogleApplicationId):Observable<any>{
    return this.http.post<any>(this.baseurl + 'LOS-V2-Initiate_E-mandate', {Request_Key,GoogleApplicationId});
  }

  submitLoanApplication(Request_Key,GoogleApplicationId):Observable<any>{
    return this.http.post<any>(this.baseurl + 'LOS-V2-Submit_Loan_Application', {Request_Key,GoogleApplicationId});
  }

  userApplicationStatus(Request_Key,GoogleApplicationId):Observable<any>{
