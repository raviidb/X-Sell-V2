...
export class ChatSectionComponent implements OnInit {
  ...
  ngOnInit(){
    ...
    this.professionForm = this.formBuilder.group({
      emp_Type : [''], work_exp : [''], income_type : [''], company_name: [''] , ownership_type:[''], flat_details : [''], 
  ...
  onSubmitEmpInfo(){
    ...
    this.service.getStep4Info(this.routerKey,this.value2,this.professionForm.value.income_type,
      this.professionForm.value.work_exp,this.professionForm.value.company_name,this.professionForm.value.emp_Type).subscribe(res=>{
        ...
        this.service.getStep5Info(this.routerKey,'Office Address',this.professionForm.value.ownership_type,
