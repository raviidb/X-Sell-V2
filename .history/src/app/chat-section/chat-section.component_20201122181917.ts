  ...
  onSubmitBankingDetails(){
    ...
    this.service.sendBankingInfo(this.routerKey,this.bankingDetailForm.value.Bank_Name,this.bankingDetailForm.value.Account_Holder_Name,
      this.bankingDetailForm.value.Account_Number,this.bankingDetailForm.value.IFSC_Code).subscribe(res=>{
        this.service.getDetails(this.routerKey).subscribe(res=>{
          this.bankingDetailForm.controls['Bank_Name'].setValue(res.UserInfo[0].Bank_Name);
          this.bankingDetailForm.controls['Account_Holder_Name'].setValue(res.UserInfo[0].Account_Holder_Name);
          this.bankingDetailForm.controls['Account_Number'].setValue(res.UserInfo[0].Account_Number);
          this.bankingDetailForm.controls['IFSC_Code'].setValue(res.UserInfo[0].IFSC_Code);
          this.service.sfdcStep2(this.routerKey,res.UserInfo[0].Google_Application_Id).subscribe(res=>{
