          ...
          if(res.status == 'Success'){
            ...
            for(let i=0; i<res.response[0].Address.length;i++){
              if(res.response[0].Address[i].Address_Type == 'Residential Address'){
                this.residenceForm.controls['residence_time'].setValue(res.response[0].UserInfo[0].TimeAtCurrentResidence);
                this.residenceForm.controls['ownership_type'].setValue(res.response[0].UserInfo[0].Ownership_Type);
                this.residenceForm.controls['flat_details'].setValue(res.response[0].UserInfo[0].Flat_OR_Building_Details);
                this.residenceForm.controls['area_details'].setValue(res.response[0].UserInfo[0].Area_OR_Street);
                this.residenceForm.controls['landmark'].setValue(res.response[0].UserInfo[0].Landmark);
                this.residenceForm.controls['postal_code'].setValue(res.response[0].UserInfo[0].Postal_Code);
                this.residenceForm.controls['city'].setValue(res.response[0].UserInfo[0].City);
                this.residenceForm.controls['state'].setValue(res.response[0].UserInfo[0].State);
                this.residenceForm.controls['country'].setValue(res.response[0].UserInfo[0].County);
              }
            }
          }
        });
