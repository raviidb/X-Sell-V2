...
export class ChatSectionComponent implements OnInit {
  ...
  ngOnInit(){
    this.userDetailForm = this.formBuilder.group({
      dob : [''], panCard : [''], gender : [''], emailAddress : ['' , [Validators.email]]
    });
  ...
  onSubmitEmpInfo(){
    ...
    this.service.getStep4Info(123,this.professionForm.value.amount,this.professionForm.value.income_type,
      this.professionForm.value.work_exp,'',this.professionForm.value.emp_Type)
  }
  ...
  onSubmitComAddressInfo(){
    ...
    this.service.getStep5Info(123,this.residenceForm.value.residence_type,'',this.residenceForm.value.flat_details,
