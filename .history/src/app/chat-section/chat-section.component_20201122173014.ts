  ...
  kycModal(event){
    ...
    if(event == 1){
      let kycDetails = {
        ...
        "Borrower_Email": this.userDetails.UserInfo[0].Email_Address,
        "Loan_Number": "NULL",
        "Contact_ID": "NULL",
      ...
      this.service.initiateEMandate(this.routerKey,this.userDetails.UserInfo[0].Google_Application_Id).subscribe(res=>{
      ...
      let ldsDetails = {
        ...
        "Last_Name":"",
        "Father_Name":this.userDetails.UserInfo[0].Father_Name,
        "PAN":this.userDetails.UserInfo[0].PAN,
