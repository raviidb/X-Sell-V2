...
export class HttpRequestService {
  ...
  getStep1Info(Request_Key,Mobile,Name):Observable<any>{
    return this.http.post<any>(this.baseurl + 'XSell_UserInfoV2Step1' , {Request_Key,Mobile,Name})
  }
  ...
  getStep5Info(Request_Key,Address_Type,Ownership_Type,Flat_OR_Building_Details,Area_OR_Street,Landmark,Postal_Code,State,County,City):Observable<any>{
    return this.http.post<any>(this.baseurl + 'XSell_UserInfoV2Step5' , 
    {Request_Key,Address_Type,Ownership_Type,Flat_OR_Building_Details,Area_OR_Street,Landmark,Postal_Code,State,County,City})
  }
